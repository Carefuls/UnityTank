...
public class TankHealth : MonoBehaviour
{
    ...
    public void TakeHealth(float amount)
    {
        ...
        SetHealthUI();                //（6-04）更新坦克血量显示；
    }

    //（6-01）调整坦克血条的数值以及血条的颜色
    private void SetHealthUI()
    {
        ...
        // a	颜色 a。b	颜色 b。 t	用于组合 a 和 b 的浮点数。
    }
